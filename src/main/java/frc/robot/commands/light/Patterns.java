...
import static edu.wpi.first.wpilibj.util.Color.kDarkGreen;
...
public class Patterns {
    ...
    public static final LightPattern CONE_PICKUP  = new LightPattern(kOrangeRed, kOrangeRed, kOrangeRed, kOrangeRed, kOrangeRed,
    ...
    public static final LightPattern ARM_UP       = new LightPattern(kDarkGreen, kDarkGreen, kDarkGreen, kDarkGreen, kDarkGreen,
        kDarkGreen, kDarkGreen, kDarkGreen, kDarkGreen, kDarkGreen, kDarkGreen, kDarkGreen, kDarkGreen, kDarkGreen, kDarkGreen);
