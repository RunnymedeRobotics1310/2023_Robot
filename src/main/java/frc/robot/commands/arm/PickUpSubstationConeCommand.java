...
public class PickUpSubstationConeCommand extends CommandBase {
    ...
    public PickUpSubstationConeCommand(ArmSubsystem armSubsystem) {
    ...
    public void initialize() {
        ...
        System.out.println("PickUpSubstationConeCommand started");
