...
public class HA_DriveOnHeadingCommand extends CommandBase {
     ...
     */
    public HA_DriveOnHeadingCommand(double heading, double speed, double distanceCm,
     ...
     * @param driveSubsystem
     */
    public HA_DriveOnHeadingCommand(double heading, double speed, double distanceCm, boolean brakeAtEnd,
        DriveSubsystem driveSubsystem) {
     ...
     * @param driveSubsystem
     */
    public HA_DriveOnHeadingCommand(double heading, double speed, double distanceCm, double timeoutSeconds,
        DriveSubsystem driveSubsystem) {
